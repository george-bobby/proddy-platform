      ...
      <Body style={main}>
        <Container style={container}>
          ...
          <Section style={section}>
            ...
            <Text style={text}>
              Here's your weekly summary for <strong>{weekRange}</strong> across all your Proddy workspaces.
            </Text>
              ...
              <Section key={index} style={workspaceSection}>
                ...
                <div style={workspaceStats}>
                  <Text style={workspaceStatText}>
                    ...
                    ✅ <strong>{workspace.stats.completedTasks}/{workspace.stats.totalTasks}</strong> tasks completed • 
            ...
            <Section style={footer}>
              ...
              <Text style={footerText}>
                ...
                {' • '}
                <Link href="https://proddy.tech/unsubscribe" style={link}>
                  Unsubscribe
                </Link>
              </Text>
            </Section>
