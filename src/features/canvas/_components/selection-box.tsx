        ...
        {isShowingHandles && (
          <>
            <rect
              ...
              onPointerDown={(e) => {
                e.stopPropagation();
                onResizeHandlePointerDown(combineSides(Side.Top, Side.Left), bounds);
              }}
            />
            <rect
              className="fill-white stroke-1 stroke-blue-500"
            ...
            <rect
              ...
              onPointerDown={(e) => {
                e.stopPropagation();
                onResizeHandlePointerDown(combineSides(Side.Top, Side.Right), bounds);
              }}
            />
            <rect
              className="fill-white stroke-1 stroke-blue-500"
            ...
            <rect
              ...
              onPointerDown={(e) => {
                e.stopPropagation();
                onResizeHandlePointerDown(combineSides(Side.Bottom, Side.Right), bounds);
              }}
            />
            <rect
              className="fill-white stroke-1 stroke-blue-500"
            ...
            <rect
              ...
              onPointerDown={(e) => {
                e.stopPropagation();
                onResizeHandlePointerDown(combineSides(Side.Bottom, Side.Left), bounds);
              }}
            />
            <rect
              className="fill-white stroke-1 stroke-blue-500"
