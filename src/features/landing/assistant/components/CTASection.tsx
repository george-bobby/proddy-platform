    ...
    >
      ...
      <div className="container px-6 md:px-8 mx-auto relative z-10 max-w-4xl">
        ...
        >
          ...
          >
            Join thousands of teams already using Proddy AI to streamline their workflow and boost productivity.
            Start your free trial today and see the difference intelligent assistance can make.
          </motion.p>
