...
const Benefit = ({ title, description, icon, delay }: BenefitProps) => {
  ...
  return (
    ...
    >
      <div className="p-3 rounded-xl bg-white shadow-md mb-5 w-16 h-16 flex items-center justify-center">
        {icon}
      </div>
    ...
    <section className="py-20 md:py-32 bg-gray-50 relative overflow-hidden">
      ...
      <div className="container px-4 md:px-6 mx-auto relative z-10">
        ...
        <motion.div
          ...
          className="mt-20 bg-white rounded-2xl shadow-xl p-6 md:p-10"
        >
