      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            >
              Have questions about Proddy? We're here to help. Reach out to our team and we'll get back to you as soon as possible.
            </motion.p>
          </div>
        </div>
      </section>
            ...
            >
              ...
              <div className="mt-12">
                ...
                <div className="flex space-x-4">
                  <a href="#" className="bg-gray-100 p-3 rounded-full hover:bg-primary/10 transition-colors">
