        ...
        <div className="flex items-center gap-1">
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button
                variant="ghost"
                className="flex items-center gap-2 overflow-hidden p-1.5 text-primary-foreground hover:bg-primary-foreground/10"
                size="sm"
              >
            ...
            <DropdownMenuContent side="bottom" align="start" className="w-64">
              ...
              {isAdmin && (
                <>
                  ...
                  >
                    <div className="flex h-5 w-5 items-center justify-center rounded-md bg-primary/10">
                      <SquarePen className="size-3 text-primary" />
                    </div>
              ...
              <div className="flex flex-col gap-y-2 p-4">
                {workspaces?.map((item) => (
                  <button
                    ...
                    className="flex w-full cursor-pointer items-center gap-x-3 rounded-lg border bg-card px-4 py-2.5 hover:bg-accent/10 transition-colors"
                  >
                    ...
                    {item._id === workspace._id && (
                      <div className="ml-auto rounded-full bg-primary/20 px-2 py-0.5 text-xs font-medium text-primary">
                        Active
                      </div>
                    )}
                  </button>
                ...
                {isAdmin && (
                  <button
                    ...
                    className="flex w-full cursor-pointer items-center gap-x-3 rounded-lg border border-dashed bg-card/50 px-4 py-2.5 hover:bg-accent/10 transition-colors"
                  >
                    <div className="flex h-8 w-8 items-center justify-center rounded-md bg-primary/80 text-primary-foreground">
