...
import { X, Check, ArrowRight, Users, Zap, Clock, Layers, BarChart, Sparkles, PaintBucket, Bot } from 'lucide-react';
...
export default function WhyProddyPage() {
  ...
  const comparisonItems = [
    ...
    },
    {
      ...
      proddy: "AI deeply integrated with daily recaps and smart summarization",
    },
    {
      title: "Customization",
    ...
    },
    {
      ...
      proddy: "Unified data model with cross-module insights and analytics",
    },
    {
      title: "Visual Collaboration",
      traditional: "Limited whiteboarding capabilities or separate tools",
      proddy: "Integrated canvas for real-time visual collaboration",
    },
  ];
  ...
  const benefits = [
    ...
    },
    {
      ...
      title: "Daily Recaps",
      description: "AI-generated summaries of your day's activities and conversations, ensuring you never miss important updates.",
    },
    {
      icon: <BarChart className="size-6" />,
      title: "Smart Summarization",
      description: "Instantly summarize long message threads and conversations to quickly get the key points.",
    },
    {
      icon: <PaintBucket className="size-6" />,
      title: "Visual Canvas",
      description: "Collaborative whiteboarding with real-time drawing, shapes, and sticky notes for visual brainstorming.",
    },
    {
      icon: <Bot className="size-6" />,
      title: "AI Assistant",
      description: "Intelligent assistance across all modules, from message summarization to content suggestions.",
    },
    {
      icon: <Layers className="size-6" />,
      title: "Unified Analytics",
      description: "Cross-module insights and activity tracking to understand team performance and engagement.",
    },
  ];
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                >
                  ...
                  enhanced by AI-powered daily recaps, smart summarization, and a collaborative canvas for visual thinking.
                </motion.p>
                <motion.div
                  initial={{ opacity: 0, y: 20 }}
                  animate={isHeroInView ? { opacity: 1, y: 0 } : { opacity: 0, y: 20 }}
            ...
            <div className="max-w-7xl mx-auto px-6 md:px-10 text-center">
              ...
              >
                 The average knowledge worker uses 9+ different applications daily,
                  wasting up to 60 minutes per day just navigating between them. Proddy's integrated platform with
                  AI-powered daily recaps, smart summarization, and collaborative canvas solves these challenges:
                </motion.p>
            </div>
          </div>
        ...
        <section className="py-20 bg-gray-50 relative overflow-hidden w-full">
          ...
          <div className="w-full bg-gradient-to-r from-white to-gray-50 py-12 mb-16">
            <div className="max-w-7xl mx-auto px-6 md:px-10 text-center">
              ...
              >
                Discover how Proddy's unique features like daily recaps, smart summarization, and collaborative canvas transform the way teams work together.
              </motion.p>
            </div>
          </div>
